...
public class Konsole {
    ...
    com.uni.controller.KursFileController vorlesungFileController;
    ...
    private void ui_getAllCoursesFromFile(){
        ...
        try {
            for (Vorlesung vorlesung: vorlesungFileController.controller_getAll()) {
                System.out.println(vorlesung);
            }
        } catch (IOException | ClassNotFoundException e) {
    ...
    private void ui_getAllLehrerFromFile(){
        ...
        try {
            for (Lehrer lehrer: lehrerFileController.controller_getAll()) {
                System.out.println(lehrer);
            }
        } catch (IOException | ClassNotFoundException e) {
    ...
    private void ui_addVorlesung(){
        ...
        try {
            vorlesungFileController.controller_create(Name, IdLehrer, IdVorlesung, MaxEnrollment, Credits);
        } catch (IOException e){
    ...
    private void ui_addElements(){
        ...
        try {
            vorlesungFileController.controller_create("BD", 1L, 100L, 30, 5);
            vorlesungFileController.controller_create("BD2", 2L, 101L, 31, 6);
            vorlesungFileController.controller_create("BD3", 1L, 102L, 32, 7);
        } catch (IOException e) {
            System.out.println("Problem mit der Einfugung von Daten " + e.getMessage());
        }
    ...
    public void ui_setFileNames(){
        ...
        vorlesungFileController = new com.uni.controller.KursFileController();
        try {
            vorlesungFileController = new com.uni.controller.KursFileController(vorlesungFileName);
        } catch (IOException e) {
